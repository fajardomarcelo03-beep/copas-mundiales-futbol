...
},
{
  ...
  es: {
    titulo: "Matías Oyola deja Barcelona",
    subtitulo: "El 'Poni' se aparta de su cargo tras la eliminación en la Copa Libertadores.",
    contenido: "Matías Oyola dejó el cargo de Director Deportivo en Barcelona SC por supuestas discrepancias con la directiva y el DT César Farías a causa de la eliminación en la Copa Libertadores; aún se espera el pronunciamiento oficial del club.",
    fecha: "4 de junio de 2026",
    tiempoLectura: "2 min"
  },
  en: {
    titulo: "Matías Oyola leaves Barcelona",
    subtitulo: "The 'Poni' steps down from his position following the elimination from the Copa Libertadores.",
    contenido: "Matías Oyola has left his role as Sporting Director at Barcelona SC due to alleged disagreements with the board and manager César Farías following their elimination from the Copa Libertadores; the club's official statement is still pending.",
    fecha: "June 4, 2026",
    tiempoLectura: "2 min"
  }
},
