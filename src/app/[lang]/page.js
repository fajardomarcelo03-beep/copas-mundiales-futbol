...
export default function HomePage() {
  ...
  // HE AGREGADO 'path' PARA QUE EL ENLACE SEA CORRECTO SEGÚN TUS CARPETAS
  const secciones = [
              ...
              {noticiasMostradas.map((noticia) => (
                <div key={noticia.id} style={cardStyle}>
                  ...
                  <div style={cardContentStyle}>
                    ...
                    {/* AQUÍ ESTÁ EL CAMBIO: usamos seccion.path para que coincida con tus carpetas */}
...
// MANTENEMOS TUS ESTILOS IGUALES
...
const tituloSeccionStyle = { color: '#0a192f', fontSize: '1.5rem', marginBottom: '25px', fontWeight: '800', borderLeft: '5px solid #f1c40f', paddingLeft: '15px' };'use client';
